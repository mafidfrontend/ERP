...
const groupData = {
  ...
  teacher: {
    name: 'Sarah Johnson',
    email: 'sarah.johnson@edu-center.com',
    phone: '+998 90 123 45 67'
  },
  schedule: [
    { day: 'Monday', time: '16:00 - 17:30', room: 'Room 305' },
    { day: 'Wednesday', time: '16:00 - 17:30', room: 'Room 305' },
    { day: 'Friday', time: '16:00 - 17:30', room: 'Room 305' }
  ],
  students: 18,
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your current study group</CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            <div className="grid grid-cols-2 gap-1">
              ...
              <span>{new Date(groupData.startDate).toLocaleDateString()}</span>
              
              <span className="text-muted-foreground">End Date:</span>
              <span>{new Date(groupData.endDate).toLocaleDateString()}</span>
            </div>
          </CardContent>
        </Card>
